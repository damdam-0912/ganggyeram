const CACHE='ganggyeram-v4-nai-meta';
const ASSETS=['./','./index.html','./styles.css?v=4','./app.js?v=4','./manifest.webmanifest?v=4','./icons/icon-192.png?v=4','./icons/icon-512.png?v=4','./icons/icon-180.png?v=4'];
